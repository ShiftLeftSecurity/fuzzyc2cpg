...
object NodeProperty extends Enumeration {
  ...
  AST_PARENT_FULL_NAME, LINE_NUMBER, COLUMN_NUMBER, LINE_NUMBER_END, COLUMN_NUMBER_END, ALIAS_TYPE_FULL_NAME,
  INHERITS_FROM_TYPE_FULL_NAME, CANONICAL_NAME = Value
}
