...
import io.shiftleft.fuzzyc2cpg.{FuzzyC2CpgCache, Global, ModuleLexer, ModuleParser}
...
class AstVisitor(driver: AntlrCModuleParserDriver,
                 astParentNode: NamespaceBlock,
