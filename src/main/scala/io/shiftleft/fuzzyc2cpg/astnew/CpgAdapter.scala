...
object NodeProperty extends Enumeration {
  ...
  DISPATCH_TYPE, METHOD_FULL_NAME, IS_EXTERNAL, PARSER_TYPE_NAME, AST_PARENT_TYPE,
  AST_PARENT_FULL_NAME, LINE_NUMBER, COLUMN_NUMBER, ALIAS_TYPE_FULL_NAME = Value
}

object NodeKind extends Enumeration {
  type NodeKind = Value
  val METHOD, METHOD_RETURN, METHOD_PARAMETER_IN, CALL, LITERAL, IDENTIFIER, BLOCK, RETURN, LOCAL, TYPE,
